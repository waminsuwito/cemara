        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <form onSubmit={onSave}>
                ...
                <div className="grid gap-4 py-4">
                    ...
                    {(role === 'SUPER_ADMIN' || role === 'LOCATION_ADMIN' || role === 'KEPALA_BP') && (
                         <div className="grid grid-cols-4 items-center gap-4">
                            <Label htmlFor="username" className="text-right">Username</Label>
                    ...
                    {(role === 'LOCATION_ADMIN' || role === 'OPERATOR' || role === 'MEKANIK' || role === 'KEPALA_BP') && (
                        <div className="grid grid-cols-4 items-center gap-4">
                            <Label htmlFor="location" className="text-right">Lokasi</Label>
                             <Select name="location" defaultValue={editingUser?.location || (currentUser?.role === 'LOCATION_ADMIN' ? currentUser.location : '')} required={role === 'OPERATOR' || role === 'LOCATION_ADMIN' || role === 'KEPALA_BP'} disabled={!isSuperAdmin && currentUser?.role !== 'SUPER_ADMIN'}>
                                <SelectTrigger className="col-span-3">
