        ...
        <div className="flex flex-col items-center gap-6 animate-in fade-in-50 w-full max-w-lg mx-auto">
            ...
            <div className="w-full space-y-4">
                <div>
                    ...
                    <Textarea
                        placeholder="Contoh: Memproses permintaan spare part..."
                        rows={3}
                        value={workPlanPagi}
                 ...
                 <div>
                    ...
                    <Textarea
                        placeholder="Contoh: Melakukan stock opname..."
                        rows={3}
                        value={workPlanSiang}
                 ...
                 <div>
                    ...
                    <Textarea
                        placeholder="Contoh: Menyiapkan barang untuk pengiriman besok..."
                        rows={3}
                        value={workPlanMalam}
