    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <header className="bg-white shadow-md p-4 flex justify-between items-center print-hide">
                <h1 className="text-xl font-semibold">Cetak Laporan Usulan & Saran</h1>
            ...
            <main className="p-8 print-page-main">
                <div className="max-w-4xl mx-auto bg-white shadow-lg print-page-container">
                    <div className="print-page-report p-10 text-black bg-white font-sans">
                        ...
                        <h2 className="text-xl font-semibold mb-4 text-center">Laporan Usulan & Saran dari Sopir</h2>
                        
                        <div className="grid grid-cols-2 gap-x-8 mb-6 text-sm">
                            <div><span className="font-semibold">Jumlah Usulan:</span> {suggestions.length}</div>
                        ...
                        <table className="w-full text-sm border-collapse border border-gray-600">
                            <thead>
                                <tr className="bg-gray-200">
                                    ...
                                    <th className="border border-gray-600 p-2 text-left w-[50%]">Isi Usulan/Saran</th>
                                </tr>
                            </thead>
                            <tbody>
                                {suggestions.length > 0 ? suggestions.map(item => (
                                    <tr key={item.id} className="even:bg-gray-50 align-top">
                                        ...
                                        <td className="border border-gray-600 p-2">{item.suggestion}</td>
                                    </tr>
                                )) : (
                                    <tr>
                                        <td colSpan={5} className="border border-gray-600 p-4 text-center">Tidak ada usulan/saran.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
...
export default function SuggestionsPrintPage() {
    return (
