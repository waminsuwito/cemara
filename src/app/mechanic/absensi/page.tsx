        ...
        <div className="flex flex-col items-center gap-6 animate-in fade-in-50 w-full max-w-lg mx-auto">
            ...
            <div className="w-full space-y-4">
                <div>
                    ...
                    <Textarea
                        placeholder="Contoh: Mengerjakan WO untuk kendaraan BM XXXX..."
                        rows={3}
                        value={workPlanPagi}
                 ...
                 <div>
                    ...
                    <Textarea
                        placeholder="Contoh: Melakukan perbaikan rem..."
                        rows={3}
                        value={workPlanSiang}
                 ...
                 <div>
                    ...
                    <Textarea
                        placeholder="Contoh: Stand by untuk panggilan darurat..."
                        rows={3}
                        value={workPlanMalam}
